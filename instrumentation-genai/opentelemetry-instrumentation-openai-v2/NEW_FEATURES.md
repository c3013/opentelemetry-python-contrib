...
**Type:** Histogram  
**Unit:** seconds (s)  
**Description:** Duration of GenAI operations. Recorded for both streaming and non-streaming requests.
...
- The `gen_ai.client.operation` histogram records operation duration for both streaming and non-streaming requests.
- The `gen_ai.client.operation.duration` histogram also records operation duration for both streaming and non-streaming requests.
